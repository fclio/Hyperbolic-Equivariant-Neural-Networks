...
class CNN(nn.Module):
    def __init__(self, manifold: CustomLorentz = None,
        ...
        # Larger CNN with 6 layers and increased channels
        self.conv1 = self.get_Conv2d(img_dim[0], 32, kernel_size=3, stride=2, padding=1)
        self.bn1 = self.get_BatchNorm2d(32)

        self.conv2 = self.get_Conv2d(32, 64, kernel_size=3, stride=2, padding=1)
        self.bn2 = self.get_BatchNorm2d(64)

        self.conv3 = self.get_Conv2d(64, 128, kernel_size=3, stride=2, padding=1)
        self.bn3 = self.get_BatchNorm2d(128)

        self.conv4 = self.get_Conv2d(128, 256, kernel_size=3, stride=2, padding=1)
        self.bn4 = self.get_BatchNorm2d(256)

        self.conv5 = self.get_Conv2d(256, 512, kernel_size=3, stride=2, padding=1)
        self.bn5 = self.get_BatchNorm2d(512)

        self.conv6 = self.get_Conv2d(512, 512, kernel_size=3, stride=2, padding=1)
        self.bn6 = self.get_BatchNorm2d(512)
